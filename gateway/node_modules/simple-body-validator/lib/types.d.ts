...
export declare type InitialRule = string | ValidationCallback | RuleContract | BaseRule;
export declare type Rule = string | RuleContract;
...
export declare type ValidationCallback = (value: any, fail: (message: string) => void, attribute: any) => void;
